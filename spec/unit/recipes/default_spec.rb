...
describe 'node::default' do
  context 'When all attributes are default, on Ubuntu 18.04' do
    ...
    it 'should install nginx' do
      expect(chef_run).to install_package "nginx"   # run the recipe and check this box has Ngnix
    end
    ...
    it 'should create a symbolic link between sites-enabled' do
    ...
    it 'should install nmp2 via npm' do
